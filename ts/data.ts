...
// const favoritesData: userFavorites = readFavorites();

// function writeFavorites(): void {
//   const favoritesJSON = JSON.stringify(renderEntry(event));
//   localStorage.setItem('favorites-storage', favoritesJSON);

// }

// function readFavorites(): userFavorites {
//   const favoritesStorage = localStorage.getItem('favorites-storage');
//   if (favoritesStorage) {
//     const json = JSON.parse(favoritesStorage);
//     return json;
//   } else {
//     return favoritesStorage ? JSON.parse(favoritesStorage) : { favorites: [] };
//   }
// }
